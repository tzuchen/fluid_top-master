...
\item The system has $n+1$ states, and $\pi(i) = {n \choose i}/2^n$.
\item This problem is equivalent to the random walk on a hypercube problem: the reduction is exact.
\end{itemize}
