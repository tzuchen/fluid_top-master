...
load mixnorm_2500_50
load mixnorm_5000_50
load mixnorm_10000_50
load mixnorm_20000_50
load mixnorm_40000_50
load mixnorm_80000_50


nlist = 2*[mixnorm_2500_50(:,2),mixnorm_5000_50(:,2),mixnorm_10000_50(:,2),mixnorm_20000_50(:,2),mixnorm_40000_50(:,2),mixnorm_80000_50(:,2)]';
[dl,iter] = size(nlist);

dlist = [2500 5000 10000 20000 40000 80000];

for i = 1:dl
 % w{i} = sprintf('n = %2.1e',dlist(i));
...
for i = 4:6
thline = plot(0:49,nlist(i,:),'color',[0 0 0],'linewidth',1);
end

for i = 1:6

h(i) = plot(0:49,nlist(i,:));
set(h(i),'color',cm(i,:) );
...
title('Simulation of Standard Map','fontsize',fzl,'interpreter','latex');
set(gca,'fontsize',fz);
...
axes('position',[0.62 0.28 0.2 0.2])
hold on
box on
...
%g1 = plot(log(-log(1./dlist.^2)),totalarea1-areai)
%set(g1,'linewidth',2);
%g2 = plot(log(-log(1./dlist.^2)),totalarea1-areai,'s')
