% produces the abstract for publication by University Microfilms, Inc.
% Needs to be ``texed'' as a single separate file (don't include in thesis.tex)
% Written by Jan Van Mieghem, April 10, 1995
