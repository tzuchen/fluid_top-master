...
\todo{MW: Why are we choosing a Borel measure above? Is $X$ a subset
  of $\mathbb{R}^n$?}

\todo{MW: It's generally better to use textbf and other latex font
  commands than bfseries, etc.}

\todo{MW: Use the text command from amsmath inside math environments
